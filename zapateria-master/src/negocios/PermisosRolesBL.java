/*
 Gestion de la tabla PermisosRoles en la base de datos
 */
package negocios;
/*
...
public class PermisosRolesBL extends BaseBL {
  ...
  // Si no existe la tabla PermisosRolesBL Crearla Automaticamente
        if (!cxn.tableExist(tableName)) {
          ...
          // conexion a la base de datos
           ...
           //manejo de excepcion por valores null o vacios
...
/*
 actulizar registro en la tabla PermisosRolesBL de la base de datos
 */
...
/*
 eliminar registro en la tabla PermisosRolesBL de la base de datos
 */
...
/*
 Listar registro en la tabla PermisosRolesBL de la base de datos
 */
